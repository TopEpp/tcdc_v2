        ...
        <div class=" container-fluid   container-fixed-lg">
          ...
          <div class=" container-fluid   container-fixed-lg">
            <div id="rootwizard" class="m-t-50">
                  ...
                  <div class="col-md-5 b-r b-dashed b-grey ">
                    <div class="padding-30 sm-padding-5 sm-m-t-15 m-t-50">
                      ...
                      <div class="profile-img-wrapper2 m-t-5 inline">
                        <img width="70" height="70" alt="" src="../assets/img/profiles/pr_s1150.jpg">
                        <div class="chat-status available">
                        </div>
                      </div>
                      <div class="inline m-l-20">
                        <p class="m-t-5">ชื่อ- สกุล : นันธิดา แก้วจันทร์
                          <br>อาชีพ : นักออกแบบ<br>ที่อยู่ : 745/4 ต.สุเทพ อ.เมือง จ.เชียงใหม่ 50000</p>
                        </div>
                      ...
                      <div class="padding-30 sm-padding-5">
                        <form role="form">
                              ...
                              <div class="col-sm-2">
                                <div class="form-group form-group-default required form-group-default-selectFx">
                                  ...
                                  <select class="cs-select cs-skin-slide cs-transparent form-control" data-init-plugin="cs-select">
                                    <option value="00" Selected>โปรดเลือก</option>
                          ...
                          <div class="form-group-attached">
                            <div class="form-group form-group-default required">
                              <label>ที่อยู่</label>
                              <input type="text" class="form-control" placeholder="โปรดระบุบที่อยู่ปัจจุบันของคุณ" required>
                            </div>
                            <div class="row clearfix">
                              <div class="col-sm-6">
                                <div class="form-group form-group-default required form-group-default-selectFx">
                            ...
                            <div class="row clearfix">
                              <div class="col-sm-9">
                                <div class="form-group form-group-default required">
                                  ...
                                  <input type="text" class="form-control" placeholder="ระบุแขวงหรือตำบลของคุณ" required>
                                </div>
                              </div>
                              <div class="col-sm-3">
                                <div class="form-group form-group-default required">
                            ...
                            <div class="radio radio-default">
                              <input type="radio" value="yes" name="radio1" id="radio1Yes">
                            ...
                            <div class="form-group-attached">
                              <div class="row clearfix">
                                ...
                                <div class="form-group form-group-default required">
                                  <label>ที่อยู่</label>
                                  <input type="text" class="form-control" placeholder="โปรดระบุบที่อยู่ขององค์กรหรือบริษัท" required>
                                </div>
                            ...
                            <br>
                            <div class="radio radio-default">
                              <input type="radio" value="yes" name="radio2" id="radio2Yes">
                          ...
                          <div class="row clearfix">
                            <div class="col-sm-4">
                              <div class="form-group form-group-default required form-group-default-selectFx">
                                ...
                                <select class="cs-select cs-skin-slide cs-transparent form-control" data-init-plugin="cs-select">
                                  <option value="01">งานไม้จัดแสดง</option>
                                  <option value="02">งานเหล็ก</option>
                                  <option value="03">งานร่วมสมัย</option>
                                  <option value="04">อื่นๆ</option>
                                </select>
                              </div>
                            </div>
                        ...
                        <div class="row clearfix">
                          <div class="col-sm-12">
                            ...
                            <div class="wysiwyg5-wrapper b-a b-grey">
                              <textarea id="wysiwyg5" class="wysiwyg demo-form-wysiwyg" placeholder="โปรดระบุบแนวความคิด ..." ui-jq="wysihtml5" ui-options="{
                              html: true,
              ...
              <div class="col-xs-12">
                <button id="show-modal" class="btn btn-primary btn-cons"><i class="fa fa-plus"></i> เพิ่มผลงาน
                </button>
              </div>
        ...
        <div class="col-md-7">
          <div class="padding-30 sm-padding-5">
           ...
           <form role="form">
             ...
             <div class="form-group-attached">
              <div class="row clearfix">
                <div class="col-sm">
                  ...
                  <div class="checkbox check-success">
                    <input type="checkbox"  value="check3" name="check" id="check3">
              ...
              <div class="form-group-attached">
                <div class="row clearfix">
                  ...
                  <div class="col-sm">
                   ...
                   <div class="checkbox check-success">
                    <input type="checkbox"  value="check1" name="check" id="check4">
                    <label for="check4">2 x 1.5 เมตร</label>
                  </div>
                  <div class="checkbox check-success">
                    <input type="checkbox"  value="check2" name="check" id="check5">
                    <label for="check5">2 x 3 เมตร</label>
                  </div>
                  <div class="checkbox check-success">
                    <input type="checkbox"  value="check6" name="check" id="check6">
                    <label for="check3">2 x 6 เมตร</label>
                  </div>
            ...
            <br>
            <p>3. แผนผัง แบบการจัดแสดงและคำอธิบาย *หากมี</p>
            ...
            <br>
            <p>4. เอกสารแสดงการเป็นเจ้าของผลงาน *หากมี</p>
    ...
    <div class="col-sm-12">
      ...
      <form>
        ...
        <div class="col-sm-12">
          ...
          <br>
          <div class="radio radio-default">
            <input value="yes" name="radio5" id="radio5Yes" type="radio">
            <label for="radio5Yes">ผ่านการตรวจสอบ</label>
            <input value="no" name="radio5" id="radio5No" type="radio">
            <label for="radio5No">ไม่ผ่าน</label>
          </div>
          <br>
          <h5>สิ่งที่ต้องแก้ไข</h5>
          <p class="all-caps fs-12 bold">โปรดระบุส่งที่ต้องแก้ไข : </p>
          <input id="#tagsinput" type="text" value=" " data-role="tagsinput" />
...
<div class="tab-pane slide-left padding-20 sm-no-padding" id="tab6">
       <div class="row row-same-height">
        <div class="col-md-5 b-r b-dashed b-grey ">
          <div class="padding-30 sm-padding-5 sm-m-t-15 m-t-50">
            <h2>การเผยแพร่</h2>
            <p>เราได้จัดเตรียมข้อมูลสำหรับการเตรียมการเผยแพร่ได้อย่างง่ายได้ คุณสามารถคัดลอกและบันทึกเพื่อนำไปใช้ต่อในสื่ออื่นๆได้</p>
            <br>
            <h5>โปรไฟล์ผู้ใช้งาน</h5>
            <br>
        ...
        <div class="col-md-7">
          <div class="padding-30 sm-padding-5">
           ...
           <form role="form">
             ...
             <div class="form-group-attached">
              <div class="row clearfix">
                <div class="col-sm">
                  ...
                  <h5>การเวลาที่เที่ยงตรง : เครื่องเงินประยุค</h5>
              ...
              <div class="form-group-attached">
                <div class="row clearfix">
                  ...
                  <div class="col-sm">
                   ...
                   <p>ประเภทผลงาน : เครื่องเงินประยุค</p>
                   <p>วัสดุ : เงิน</p>
                   <p>วันที่ออกแบบ : 06/02/2559</p>
                   <p>ขนาดผลงาน : 23 x 20 x 15 ซม.</p>
                   <p>ออกแบบโดย : นันธิดา แก้วจันทร์</p>
            ...
            <div class="form-group-attached">
              <div class="row clearfix">
                ...
                <div class="col-sm-12">
                 ...
                 <br>
                 <img class="sm-padding-5" src="../assets/img/user/up_file2256.jpg"><img src="../assets/img/user/up_file2256.jpg"><img src="../assets/img/user/up_file2256.jpg">
            ...
            <p>4. แนวความคิด</p>
            <br>
            <p>CNN เผยผลสำรวจ ยังเจอโฆษณาจากแบรนด์ดังเป็นร้อยแบรนด์ ทั้ง Adidas, Amazon, Hershey, Netflix แม้กระทั่งโฆษณาจากรัฐบาลสหรัฐฯ ปรากฏควบคู่กับเนื้อหาสุดโต่งรุนแรง

ตัวอย่างเช่น โฆษณาส่งเสริมการพัฒนาเด็ก ปรากฏคู่กับคลิปที่มีเนื้อหาส่งเสริมการละเมิดทางเพศเด็ก, เนื้อหาส่งเสริมนาซี และโฆษณาของหน่วยงานขนส่ง, ศูนย์ควบคุมโรค ก็ปรากฏคู่กับช่อง YouTube ที่สนับสนุนโฆษณาชวนเชื่อของเกาหลีเหนือ

ก่อนหน้านี้หลายเดือน YouTube เจอบรรดาแบรนด์โฆษณาบอยคอตไม่ลงโฆษณากับ YouTube เพราะปัญหาเนื้อหารุนแรงมาแล้ว และ YouTube ก็สัญญาจะแก้ปัญหา เพิ่มคน เพิ่มประสิทธิภาพเทคโนโลยีในการตรวจจับ เพิ่มนโยบายเช้มงวดแก่คนทำช่อง YouTube ทำให้แบรนด์บางแบรนด์เริ่มกลับมาลงโฆษณาเพราะ YouTube ก็ยังคงเป็นโซเชียลวิดีดอที่คนใช้มาก

แต่ระบบการแสดงโฆษณาของ YouTube ยังเป็นอัตโนมัติเสียส่วนใหญ่ และจากการที่ปัญหานี้ยังคงอยู่ แสดงให้เห็นว่า การใช้คนทำงานตรงนี้ยังจำเป็นมาก</p>
