    ...
    padding: 0px;
      ...
      <div class="content ">
        <div class=" container-fluid   container-fixed-lg">
          ...
          <?php $attributes = array('name' => 'frmAppv', 'id' => 'form-event-profile');
            ...
            <div id="event-form" class="m-t-50">
             ...
             <!-- show validate error -->
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
                ...
                <li class="nav-item">
                  <a class="" data-toggle="tab" href="#tab2" role="tab"><img src="<?php echo base_url('assets/img/icons/1.png');?>" width="10px"> <span>ข้อมูลบุคคล/องค์กร</span></a>
                </li>
                <li class="nav-item">
                  <a class="" data-toggle="tab" href="#tab3" role="tab"><img src="<?php echo base_url('assets/img/icons/2.png');?>" width="10px"> <span>ผลงานออกแบบ</span></a>
                </li>
                <li class="nav-item">
                  <a class="" data-toggle="tab" href="#tab4" role="tab"><img src="<?php echo base_url('assets/img/icons/3.png');?>" width="10px"> <span>วิธีการจัดแสดง</span></a>
                </li>
                <li class="nav-item">
                  <a class="" data-toggle="tab" href="#tab5" role="tab"><img src="<?php echo base_url('assets/img/icons/4.png');?>" width="10px"> <span>แบบประเมินผล</span></a>
                </li>
              </ul>
              <!-- Tab panes -->
                                          ...
                                          <div class="row clearfix">
                                            <div class="col-sm-12">
                                              ...
                                              <div class="wysiwyg5-wrapper b-a b-grey">
                                                <textarea name="product_concept[]" id="" class="product_concept "  placeholder="" ui-jq="wysihtml5" ui-options="{
                                                html: true,
