...
?>
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
                ...
                <li class="nav-item">
                  <a class="" data-toggle="tab" href="#tab3" role="tab"><img src="<?php echo base_url('assets/img/icons/3.png'); ?>" width="10px"> <span><?=lang('Talk/Workshop');?></span></a>
                </li>
                <li class="nav-item">
    ...
    $status2 = '';
                ...
                <div class="tab-pane  slide-left padding-20 sm-no-padding " id="tab3">
                  <div class="row row-same-height">
                    <div class="col-md-12">
                      <div class="padding-30 sm-padding-5">
                        <p style="font-weight: bold;"><?=lang('Type');?> <span style="color:red;">*</span></p>
                        <div class="row clearfix">
                              ...
                              <div class="row">
                                <div class="col-sm-5">
                                  <div class="checkbox check-success">
                                    ...
                                    <label for="work_talk_ty1"><?=lang('Talk');?></label>
                                  </div>
                                </div>
                                      ...
                                      <div class="row">
                                        <div class="col-sm-6">
                                          <div class="checkbox check-success">
                                            ...
                                            <label for="work_talk_ty_at2"><?=lang('out_At');?></label>
                                          </div>
                                        </div>
                              ...
                              <div class="row">
                                <div class="col-sm-5">
                                  <div class="checkbox check-success">
                                    ...
                                    <label for="work_talk_ty2"><?=lang('Workshop');?></label>
                                  </div>
                                </div>
                                      ...
                                      <div class="row">
                                        <div class="col-sm-6">
                                          <div class="checkbox check-success">
                                            ...
                                            <label for="work_talk_ty_at4"><?=lang('ME_At');?></label>
                                          </div>
                                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                            <p style="font-weight: bold;"><?=lang('Title_Thai');?></p>
                              <div class="form-group form-group-default required">
                              <label>&nbsp;</label>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                            <p style="font-weight: bold;"><?=lang('Title_English');?></p>
                              <div class="form-group form-group-default required">
                              <label>&nbsp;</label>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                            <p style="font-weight: bold;"><?=lang('Speaker_Name');?></p>
                              <div class="form-group form-group-default required">
                                <label>&nbsp;</label>
                        ...
                        <div class="row clearfix">
                          <div class="col-sm-12">
                            <p style="font-weight: bold;"><?=lang('Scope_of_Content_and_Format');?></p>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                            <p style="font-weight: bold;"><?lang('The_Content_Scope_is_Suitable_for');?></p>
                              <div class="form-group form-group-default required form-group-default-selectFx">
                                <label>&nbsp;</label>
                                <select style="width:100%;"  id="work_talk_scope" name="work_talk_scope" class="cs-select cs-skin-slide cs-transparent form-control" data-init-plugin="select2" data-disable-search="true">
                                  ...
                                  <option  <?php echo (@$regis['work_talk_scope'] == '') ? 'selected' : ''; ?> value="" ><?lang('Select');?></option>
                                  <option  <?php echo (@$regis['work_talk_scope'] == 1) ? 'selected' : ''; ?> value="1"><?=lang('Everyone');?></option>
                                  <option  <?php echo (@$regis['work_talk_scope'] == 2) ? 'selected' : ''; ?> value="2"><?=lang('Designers');?></option>
                                  <option  <?php echo (@$regis['work_talk_scope'] == 3) ? 'selected' : ''; ?> value="3"><?=lang('Businesspeople');?></option>
                                  <option  <?php echo (@$regis['work_talk_scope'] == 4) ? 'selected' : ''; ?> value="4"><?=lang('Others');?></option>
                                </select>
                              </div>
                            </div>
                        </div>
                        ...
                        <div class=" row clearfix">
                          <div class="col-sm-12">
                            <div class="form-group required "  style="padding-left: 8px;">
                              ...
                              <label ><?=lang('Guest_Speaker');?> <span style="color:red; font-size:18px;"><?=lang('JPG_file_only');?></span> </label>
                              <div class="row">
                                  <div class="col-sm-12">
...
?>
                        ...
                        <div class=" col-sm-12">
                          <div class=" form-group">
                            <label><?=lang('Image_lecturer');?> <span style="color:red; font-size:18px;"><?=lang('JPG_file_only');?></span></label>
                            <div class="row">
...
?>
                        ...
                        <div class=" col-sm-12">
                          <div class=" form-group">
                          <label><?=lang('Graphics or images of past events');?> <span style="color:red; font-size:18px;"><?=lang('JPG_file_only');?></span></label>
                            <div class="row">
