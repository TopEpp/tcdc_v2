      ...
      <div class=" justify-content-center flex-column  ">
        ...
        <div id="myFormWizard">
          ...
          <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
            <li class="nav-item">
              <a class="active" data-toggle="tab" href="#tab1" role="tab"><img src="<?php echo base_url('assets/img/icons/1.png'); ?>" width="10px">  <span ><?=lang('Create_User');?></span></a>
            </li>
            <li class="nav-item">
              <a data-toggle="tab" href="#tab2" role="tab"><img src="<?php echo base_url('assets/img/icons/2.png'); ?>" width="11px"> <span  ><?=lang('User_Information');?></span></a>
            </li>
            <!-- <li class="nav-item">
...
?>
          ...
          <div class="tab-content">
            <div class="tab-pane active slide" id="tab1">
                ...
                <div class="row">
                  <div class="col-md-12" >
                    <div class="form-group form-group-default required">
                      <label style="font-family: 'dbch', sans-serif;"><?=lang('Email');?></label><span class="text-danger"><?php echo form_error('email'); ?></span>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group form-group-default required">
                      <label style="font-family: 'dbch', sans-serif;"><?=lang('Confirm_Email');?></label>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group form-group-default required">
                      <label><?=lang('Confirm_Password');?></label><span class="text-danger"><?php echo form_error('password_again'); ?></span>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group form-group-default  form-group-default-selectFx required ">
                      <label><?=lang('Title');?></label><span class="text-danger"><?php echo form_error('prename'); ?></span>
                      <select  style="width:100%"  id="prename" name="prename">

                        <option disabled <?php echo (@set_value('prename') == '') ? 'selected' : ''; ?> value="" ><?=lang('Select');?></option>
                        <option  <?php echo (@set_value('prename') == 1) ? 'selected' : ''; ?> value="1"><?=lang('Mr.');?></option>
                        <option  <?php echo (@set_value('prename') == 2) ? 'selected' : ''; ?> value="2"><?=lang('Mrs.');?></option>
                        <option  <?php echo (@set_value('prename') == 3) ? 'selected' : ''; ?> value="3"><?=lang('Ms.');?></option>
                        <option  <?php echo (@set_value('prename') == 4) ? 'selected' : ''; ?> value="4"><?=lang('Not_Specify');?></option>
                      </select>
                  ...
                  <div class="col-md-4">
                    <div class="form-group form-group-default required">
                      <label><?=lang('Last_Name');?></label><span class="text-danger"><?php echo form_error('lastname'); ?></span>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group form-group-default  form-group-default-selectFx ">
                      <label><?=lang('Birth_Date');?></label><span class="text-danger"><?php echo form_error('birthday'); ?></span>
    ...
    ?>
                  ...
                  <div class="col-md-4">
                    <div class="form-group form-group-default  form-group-default-selectFx">
                      <label><?=lang('Birth_Year');?></label><span class="text-danger"><?php echo form_error('year_of_birth'); ?></span>
    ...
    ?>
                ...
                <p style=""><?=lang('Contact_Address');?></p>
                <div class="row clearfix">
                  <div class="col-sm-12">
                    <div class="form-group form-group-default ">
                      <label><?=lang('Name_Company');?></label><span class="text-danger"><?php echo form_error('company_name'); ?></span>
                ...
                <div class="row clearfix">
                  <div class="col-sm-6">
                    <div class="form-group form-group-default required">
                      <label><?=lang('Subdistrict');?></label><span class="text-danger"><?php echo form_error('subdistrict'); ?></span>
                      <input type="text" name="subdistrict" class="form-control" placeholder="" value="<?php echo set_value('subdistrict'); ?>">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group form-group-default required">
                      <label><?=lang('District/Area');?></label><span class="text-danger"><?php echo form_error('district'); ?></span>
...
$select = '';
    if (set_value('province') == $value->code) {
        $select = 'selected="selected"';
                  ...
                  <div class="col-sm-4">
                    <div class="form-group form-group-default required">
                      <label><?=lang('Postcode');?></label><span class="text-danger"><?php echo form_error('zipcode'); ?></span>
                ...
                <div class="row m-t-10">
                  <div class="col-sm-12">
                    <div class="checkbox check-success  ">
                      ...
                      <label for="checkbox2" style="font-weight: bold;"> <?=lang('I_have_read');?></label>
                    </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    if (document.getElementById("country").value == 208){
